    ...
    <div class="header_container">
        ...
        <div class="header_right">
            <nav class="nav" id="nav_menu" aria-label="Principal">
                <a href="?page=nosotros" class="<?php echo $page === 'nosotros' ? 'nav_link_active' : ''; ?>" <?php echo $page === 'nosotros' ? 'aria-current="page"' : ''; ?> data-i18n="nav_nosotros">Nosotros</a>
                ...
                <a href="?page=lo_que_hacemos" class="<?php echo $page === 'lo_que_hacemos' ? 'nav_link_active' : ''; ?>" <?php echo $page === 'lo_que_hacemos' ? 'aria-current="page"' : ''; ?> data-i18n="nav_what_we_do">Lo que hacemos</a>
                <a href="?page=casos_de_exito" class="<?php echo $page === 'casos_de_exito' ? 'nav_link_active' : ''; ?>" <?php echo $page === 'casos_de_exito' ? 'aria-current="page"' : ''; ?> data-i18n="nav_cases">Casos de éxito</a>
