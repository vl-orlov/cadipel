...
<div class="hero_solucion hero_nosotros nosotros_page_hero">
    ...
    <a href="?page=landing" class="hero_nosotros_back" data-i18n="companias_hero_back">Volver</a>
</div>
...
<section class="whatdo_cards_section" aria-label="Lo que hacemos">
    <div class="whatdo_cards_inner">
        <div class="whatdo_cards_grid">
            ...
            <article class="whatdo_card"><img src="img/lo_que_hacemos/lo_que_hacemos7.png" alt="" class="whatdo_card_img" loading="lazy"><p class="whatdo_card_text" data-i18n="whatdo_card_7">Creamos nuevas metodologías y KNOW-HOW en la esfera de IT para crear productos modernos basados en las tecnologías "Blockchain" y "Only-WEB".</p></article>
